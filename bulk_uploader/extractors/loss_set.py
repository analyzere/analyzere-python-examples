...
SORT_COLUMNS = dict(
    elt=["event_id"], yelt=["trial_id", "day", "event_id"], ylt=["trial_id"]
)
...
class LossSetExtractor:
    ...
    def get_column_names(
        self, config, column_set=REQUIRED_COLUMNS, ifin=None
    ):
        """
    ...
    def check_required_columns(self):
        ...
        """
        required_columns = set(self.get_column_names(self.loss_set_columns))
    ...
    def get_loss_set(self, loss_set_id):
        ...
        optional_columns = self.get_column_names(
            ARE_TARGET_COLUMNS, OPTIONAL_COLUMNS, loss_set
        )
